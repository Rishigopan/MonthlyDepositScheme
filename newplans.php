    ...
    <div class="wrapper">
        ...
        <div id="content" class="container-fluid">
            ...
            <?php 
                ...
                $findplans_query = mysqli_query($conlink, "SELECT * FROM scheme_master");
                            ...
                            <div class="row g-1">
                                ...
                                <div class="col-7">
                                    ...
                                    <div class="text-center btn_join mt-2">
                                        <a href="plan_detailed.php?scheme_id=<?php echo  $result_virus['scheme_id']; ?>" class="btn shadow-none rounded-pill">
